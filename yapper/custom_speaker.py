...
# # use as follows 
# from yapper import Yapper, PiperVoice, PiperQuality
# from custom_speaker import CustomPiperSpeaker

# # Create speaker with custom speed
# speaker = CustomPiperSpeaker(
#     voice=PiperVoice.AMY,
#     quality=PiperQuality.MEDIUM,
#     speed=1.5  # 50% faster than normal
# )

# # Create Yapper instance with the custom speaker
